...
part1_test() ->
    ?assertEqual(24000, part1("test_input_day01.txt")),
    ?assertEqual(74394, part1("input_day01.txt")).

part2_test() ->
    ?assertEqual(lists:sum([24000,11000,10000]), part2("test_input_day01.txt")),
    ?assertEqual(lists:sum([74394,69863,68579]), part2("input_day01.txt")).
